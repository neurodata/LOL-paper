...
% get mins
for i=1:task.Nalgs;
    [~,Stats.mins.k(i)]=min(Stats.means.Lhats(i,:));
    Stats.mins.Lhats(i)=Stats.means.Lhats(i,Stats.mins.k(i));
    Stats.mins.sensitivity(i)=Stats.means.sensitivity(i,Stats.mins.k(i));
    Stats.mins.specificity(i)=Stats.means.specificity(i,Stats.mins.k(i));
end
