...
task1.types={'DEFL';'DEFQ';'DVFL';'DVFQ'};
[T{j},S{j},P{j}] = run_task(task1);
...
D=100;
task1=task;
task1.name=['xor, D=', num2str(D)];
task1.ntrain=10;
task1.types={'DEFL';'NEFL';'DEAL';'NEAL';'DEFR';'NEFR';'DEAR';'NEAR'};
task1.algs={'LOL';'RF'};
task1.ks=unique(floor(logspace(0,log10(D),20)));
task1.ntrials=2;
[T{j},S{j},P{j}] = run_task(task1);
