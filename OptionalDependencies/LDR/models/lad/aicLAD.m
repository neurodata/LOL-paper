function [Wmin,d,f] = aicLAD(Yaux,X,morph,parameters)
%[Wmin,d,f] = aicLAD(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the LAD model using Akaike's information criterion.
% USAGE:
%  - outputs:
