function [Wn,d,fn] = aicPFC(Yaux,X,morph,parameters)
%[Wmin,d,f] = aicPFC(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the PFC model using Akaike's information criterion.
% USAGE:
%  - outputs:
