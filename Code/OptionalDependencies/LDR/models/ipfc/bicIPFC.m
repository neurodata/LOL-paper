function [Wn,d,fn] = bicIPFC(Yaux,X,morph,parameters)
%[Wmin,d,f] = bicIPFC(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the IPFC model using Bayes information criterion.
% USAGE:
%  - outputs:
