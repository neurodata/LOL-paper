function [Wn,d,fn] = bicSPFC(Yaux,X,morph,parameters)
%[Wmin,d,f] = bicSPFC(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the SPFC model using Bayes information criterion.
% USAGE:
%  - outputs:
