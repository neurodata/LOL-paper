function [Wmin,d,f] = bicEPFC(Yaux,X,morph,parameters)
%[Wmin,d,f] = bicEPFC(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the EPFC model using Bayes information criterion.
% USAGE:
%  - outputs:
