function [Wmin,d,f] = lrtCORE(Yaux,X,morph,parameters)
% 
% [Wmin,d,f] = lrtCORE(Y,X,morph,parameters);
% 
% This function estimates the dimension of the central subspace that best
% describes the data under the CORE model using a likelihood-ratio test.
% USAGE:
%  - outputs:
