...
\Lol~is always better than or equal to  \Pca' under the Gaussian model, and better than or equal to \Pca~with relatively weak conditions.
 This is true for all possible observed dimensionality of the data, and number of dimensions into which we embed, for sufficiently large sample sizes. Moreover, these conditions hold almost surely as the number of dimensions increases.
\end{thm}
