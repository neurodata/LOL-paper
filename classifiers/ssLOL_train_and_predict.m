function [Yhat, eta, Proj] = ssLOL_train_and_predict(Xtrain, Ytrain, Xtest, varargin)
% trains and predicts semi-supervised Low-rank Optimal projection LDA
% 
% INPUT
...
Proj = ssLOL_train(Xtrain,Ytrain,varargin{1},varargin{2});
Xtilde=Proj*Xtrain;
